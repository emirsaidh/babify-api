...
namespace babify_api.Migrations
{
    ...
    [Migration("20220602125035_TummyInherit")]
    partial class TummyInherit
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("babify_api.Models.TimerActivity.Tummy", b =>
                {
                    ...
                    b.Property<int?>("ActivityModelActivityId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ActivityModelActivityId");
            ...
            modelBuilder.Entity("babify_api.Models.TimerActivity.Tummy", b =>
                {
                    b.HasOne("babify_api.Models.TimerActivity.ActivityModel", null)
                        .WithOne()
                        .HasForeignKey("babify_api.Models.TimerActivity.Tummy", "ActivityId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();

                    b.HasOne("babify_api.Models.TimerActivity.ActivityModel", null)
                        .WithMany("TummyActivities")
                        .HasForeignKey("ActivityModelActivityId");
                });
